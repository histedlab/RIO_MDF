...
amplitudeToLinePhaseMap = [5 -5.1375e-06;5.17241 -5.1375e-06;5.35714 -5.1375e-06;5.55556 -5.1375e-06;5.76923 -5.1375e-06;6 -5.1375e-06;7.5 -5.1e-06;15 -5.0125e-06];     % translates an amplitude (degrees) to a line phase (seconds)
amplitudeToFrequencyMap = [5 7926.68;6 7928.11;7.5 7932.86;10 7927.5;15 7930.5];     % translates an amplitude (degrees) to a resonant frequency (Hz)
...
% Calibration data
scannerToRefTransform = [1.16022 0.00699326 -0.149751;-0.00707051 1.54045 -0.712906;-2.04004e-17 4.62169e-16 1];
...
% Calibration data
scannerToRefTransform = [-0.354601 -1.39217 -0.186637;1.92434 -0.48239 -0.82657;0 0 1];
